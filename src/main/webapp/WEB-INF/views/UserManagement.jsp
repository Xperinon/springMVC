<%@ page language="java" contentType = "text/html" charset="ISO-8859-1" pageEncoding="ISO-8859-1" %>
    <taglib prefix="c" uri="<a class=" vglnk " href="http://java.sun.com/jsp/jstl/core " rel="nofollow
        "><span>http</span><span>://</span><span>java</span><span>.</span><span>sun</span><span>.</span><span>com</span><span>/</span><span>jsp</span><span>/</span><span>jstl</span><span>/</span><span>core</span></a>" %>
        ...
        <body ng-app="AngularJSApp" class="ng-cloak">
                        ...
                        <form ng-submit="ctrl.submit()" name="appForm" class="form-horizontal">
                            ...
                            <div class="row">
                                <div class="form-actions floatRight">
                                    <input type="submit" value="{{!ctrl.user.id ? 'Add' : 'Update'}}" class="btn btn-primary btn-sm" ng-disabled="appForm.$invalid">
            ...
            <script src="<a class=" vglnk " href="https://ajax.googleapis.com/ajax/libs/angularjs/1.4.4/angular.js " rel="nofollow "><span>https</span><span>://</span><span>ajax</span><span>.</span><span>googleapis</span><span>.</span><span>com</span>
                <span>/</span><span>ajax</span><span>/</span><span>libs</span><span>/</span><span>angularjs</span>
                <span>/</span><span>1</span><span>.</span><span>4</span><span>.</span><span>4</span><span>/</span><span>angular</span>
                <span>.</span><span>js</span></a>"></script>
